...
var Rainbow = function Rainbow(_ref) {
  ...
  var DetailedTilesList = function DetailedTilesList() {
    return /*#__PURE__*/React.createElement(TilesContainer, null, Object.keys(selectedColor).map(function (color) {
      return Object.keys(selectedColor[color]).map(function (colorScale, index) {
        var hex = selectedColor[color][colorScale];

        if (colorScale === '900') {
          return /*#__PURE__*/React.createElement(Bow, {
            key: "revert",
            bgColor: "gray-100",
  ...
  var MainTilesList = function MainTilesList() {
    return /*#__PURE__*/React.createElement(TilesContainer, null, Object.keys(colors).map(function (color) {
  ...
  }, selectedColor ? /*#__PURE__*/React.createElement(DetailedTilesList, null) : /*#__PURE__*/React.createElement(MainTilesList, null))));
};
